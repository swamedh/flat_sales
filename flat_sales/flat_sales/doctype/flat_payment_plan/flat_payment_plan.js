...
cur_frm.cscript.event2 = function(doc, cdt, cdn) {
    ...
    {
        total_amount=(doc.balance_amount*pst[i].rate)/100
        console.log(pst[i].sales_tax_rate)
        console.log(total_amount)
        tax_rates= (pst[i].sales_tax_rate + pst[i].service_tax_rate + 100) //tr=sales tax rate + service tax rate
        console.log(tax_rates)
        amount_due=((total_amount/tax_rates) * 100 ) //ta=tax amount(row)
        console.log(amount_due)
        //pst[i].paid_amount=(doc.balance_amount*pst[i].rate)/100
        pst[i].paid_amount=amount_due
        pst[i].sales_tax_amount=(pst[i].paid_amount*pst[i].sales_tax_rate)/100
        pst[i].service_tax_amount=(pst[i].paid_amount*pst[i].service_tax_rate)/100
